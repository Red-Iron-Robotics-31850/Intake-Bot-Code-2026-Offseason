...
This repository contains the offseason code for FTC Team 31850 Red Iron Robotics, for the DECODE (2025-2026) competition season.
...
* Use the "Download Zip" button available through the main repository page.  Downloading the project as a .ZIP file will keep the size of the download manageable.
